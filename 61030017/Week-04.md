...
➢ รันโปรแกรมและบันทึกผล
```
HelloHelloPress any key to continue . . .
```
...
= เป็นอย่างที่คิดเพราะรู้ว่าคำสั่ง Console.Write(); จะเป็นคำสั่งให้โปรแกรมแสดงผลโดยแสดงผลในบรรทัดที่ cursor ปัจจุบันอยู่ โดยไม่เว้นบรรทัดใหม่
...
= สามารถใช้งานได้เพราะการใช้ {ลำดับของตัวเลข} หมายถึงการแสดงค่าใดๆ ที่ Programmer กำหนดไว้เป็นลำดับตั้งแต่ 0,1,2,3,.... หลังเครื่องหมาย ” เช่น Console.Write(“Hello Mr. {2}”,0,56,38,113); เอาท์พุตที่ออกมาจะได้ Hello Mr. 38
...
= จะเกิด error ขึ้นในการดำเนิดการโปรแกรม ใช้ try{}...catch{} เข้ามาช่วย
...
ให้เขียน code ในการรับค่าอินพุตต่อไปนี้และแสดงออกหน้าจอให้ถูกต้อง
 ...
 static void Main(string[] args)
        {
           ...
           Console.WriteLine("Input your student ID");
           ID = int.Parse(Console.ReadLine());
           Console.WriteLine("Input your grade by 2 decimal digits");
           grade = float.Parse(Console.ReadLine());
            
            Console.WriteLine("Your name is {0}\nYour ID is {1}\nYour grade is {2:F2}",Name +" " + lastName,ID,grade);
        }
    }
```
...
| `null` |ใช้ไม่ได้ |มีตัวอักษรละเมิดกฏการตั้งชื่อ |
| `_value` |ใช้ได้ |ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `First-name`|ใช้ไม่ได้ |มีตัวอักษรละเมิดกฏการตั้งชื่อ |
| `Hello!` |ใช้ไม่ได้ |มีตัวอักษรละเมิดกฏการตั้งชื่อ | 
| `w*h` |ใช้ไม่ได้ |มีตัวอักษรละเมิดกฏการตั้งชื่อ | 
| `time` |ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ | 
| `do` |ใช้ไม่ได้ |มีตัวอักษรละเมิดกฏการตั้งชื่อ| 
| `Do` |ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ | 
| `21November`|ใช้ไม่ได้ |มีตัวอักษรละเมิดกฏการตั้งชื่อ | 
| `ladkrabang`|ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ  | 
| `Student ID`|ใช้ไม่ได้ |มีตัวอักษรละเมิดกฏการตั้งชื่อ |
...
class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Input number between 0-9\nIf your number is greater than random number we gonna show you => True");
            input = int.Parse(Console.ReadLine());
            getnum = random.Next(0,9);

            if (getnum > input)
                {
                    check = false;
                Console.WriteLine(check + "\nThe random number is {0}",getnum);
                }else{
}                    check = true;
                Console.WriteLine(check + "\nThe random number is {0}",getnum);
        }
...
|---|---|---|---|
| Mercury | 57,910,000 km |0.3871044403 AU|3.2195476299 light minute
| Venus | 108,200,000 km |0.7232723267 AU |6.0154559412 light minute
| Earth | 149,600,000 km |1.0000142336 AU|8.3171183809light minute
| Mars | 227,940,000 km |1.5196071907 AU|12.6385730048 light minute
| Jupiter |  778,330,000 km |5.2028146954 AU|43.2718098220 light minute
| Uranus | 2,873,550,000 km |19.2084953273 AU|159.7570556371 light minute
| Neptune | 4,501,000,000 km |30.0873266406 AU|250.2362956701 light minute
| Pluto | 5,945,900,000 km |39.7458865746 AU|330.5665386413 light minute
